        ...
        <div className="rounded-xl border border-primary/20 bg-gradient-to-b from-primary/5 to-card p-5 shadow-sm">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Análise inteligente do caixa</p>
            </div>
          </div>
          <ul className="mt-4 space-y-3 text-sm">
            <li className="rounded-lg border border-border bg-card/70 p-3">
              <p className="font-medium text-success">Fluxo positivo</p>
              <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground">
                Sua receita cresceu 12,4% vs. julho. O saldo atual cobre 4,3 meses de despesas fixas.
              </p>
            </li>
            <li className="rounded-lg border border-border bg-card/70 p-3">
              <p className="flex items-center gap-1 font-medium text-warning">
                <CircleAlert className="h-3.5 w-3.5" /> Atenção
              </p>
              <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground">
                Há R$ 49.290 em boletos atrasados (Unidas e Localiza). Sugerimos cobrança automática.
              </p>
            </li>
            <li className="rounded-lg border border-border bg-card/70 p-3">
              <p className="font-medium text-primary">Recomendação</p>
              <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground">
                A cegonha "Carreta Branca" tem a maior rentabilidade (38%). Priorize rotas SP–RJ.
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-card shadow-sm xl:col-span-2">
          <div className="flex items-center justify-between border-b border-border px-5 py-4">
            ...
            <span className="rounded-full bg-muted px-2.5 py-1 text-xs font-medium text-muted-foreground">
              {contasReceber.length} documentos
            </span>
          </div>
                ...
                {contasReceber.map((c) => (
                  <tr key={c.id} className="hover:bg-muted/40">
                    ...
                    <td className="px-4 py-3 text-right text-muted-foreground">
                      {c.valorRecebido > 0 ? formatBRL(c.valorRecebido) : "—"}
                    </td>
                    <td className="px-4 py-3">
